                            ...
                            filters={
                                ...
                                const combinedSearch = [
                                    ...
                                    */
                                    {
                                        id: 'number',
                                        label: t('ui.bookcases.filters.number') || 'Numero',
                                        type: 'number',
                                        placeholder: t('ui.bookcases.placeholders.number') || 'Numero...',
                                    },
                                    {
                                        id: 'capacity',
                                        label: t('ui.bookcases.filters.capacity') || 'Capacidad',
                                        type: 'number',
                                        placeholder: t('ui.bookcases.placeholders.capacity') || 'Capacidad...',
                                    },
                                    {
                                        id: 'floor',
                                    ...
                                    {
                                        id: 'genre',
                                        label: t('ui.bookcases.filters.genre') || 'Genero',
                                        type: 'text',
                                        placeholder: t('ui.bookcases.placeholders.genre') || 'Genero...',
                                    },
                                ] as FilterConfig[]
                            }
