...
export default function ZonesIndex() {
  ...
  const columns = useMemo(() => ([
    ...
    createTextColumn<Zone>({
      id: "genre_name",
      header: t("ui.zones.columns.genre") || "Capacity",
                      ...
                      <FiltersTable
                          filters={
                              [
                                  ...
                                  {
                                      id: 'title',
                                      label: t('ui.zones.filters.title') || 'Titulo',
                                      type: 'text',
                                      placeholder: t('ui.zones.placeholders.title') || 'Titulo...',
                                  },
                                  {
                                      id: 'author',
                                      label: t('ui.zones.filters.author') || 'Autor',
                                      type: 'text',
                                      placeholder: t('ui.zones.placeholders.author') || 'Autor...',
                                  },
                              ] as FilterConfig[]
                          }
